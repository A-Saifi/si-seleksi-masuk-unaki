...
<div class="login-box">
  <div class="login-logo">
    <a href="<?= base_url('admin') ?>">Peserta <b>Ujian</b> Online</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Username" name="username" value="<?= $this->input->get(md5('username')) ?>" required>
