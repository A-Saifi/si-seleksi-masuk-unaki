<div class="form-group">
  ...
  <input type="text" class="form-control" placeholder="Ketikkan nama kelas ..." required name="nama_kelas">
</div>
<div class="form-group">
...
<div class="form-group">
  <label>Status</label>
    <?php foreach ($status as $stat): ?>
        <br>
        <label>
        <input type="radio" name="status_kelas" value="<?= $stat  ?>" class="flat-red" required>
