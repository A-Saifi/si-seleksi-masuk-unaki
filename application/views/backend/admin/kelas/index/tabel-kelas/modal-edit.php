      ...
      <div class="modal-content">
        ...
        <form class="" action="<?= base_url('admin/kelas/ubah')  ?>" method="post">
          ...
          <div class="modal-footer">
            ...
            <?php if ($this->check_kelas->can_delete($kel->id_kelas)): ?>
            <a href="<?= base_url('admin/kelas/hapus?id='.$kel->id_kelas)  ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus kelas ini ?')">Hapus</a>
            <?php endif; ?>
